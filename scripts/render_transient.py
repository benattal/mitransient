...
parser.add_argument('--pulse-samples', type=int, default=None,
...
# Apply pulse_samples override if specified
if args.pulse_samples is not None:
    ...
    if hasattr(integrator, 'pulse_samples'):
        ...
        print(f"Warning: Integrator does not support pulse_samples parameter")
