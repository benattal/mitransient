...
def parse_args():
    ...
    parser.add_argument('--peak-width', type=int, default=5,
                        help='Half-width of direct peak mask in bins (default: 5). Bins within [peak-width, peak+width] are masked as direct.')
...
def main():
    ...
    print(f"\n[3/7] Detecting direct peaks (peak_width={args.peak_width} bins)...")
